    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'column' }}>
                ...
                />
                <View style={{ marginLeft: 10, marginTop: 10, justifyContent: 'center', alignItems: 'center', marginBottom: 10 }}>
                    <TouchableOpacity style={{ backgroundColor: 'red', width: 330, padding: 10, justifyContent: 'center', alignItems: 'center' }} onPress={this.handleLogout}>
                        <Text style={{ color: 'white' }}>Logout</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ backgroundColor: 'green', width: 330, padding: 10, justifyContent: 'center', alignItems: 'center', marginTop: 10 }} onPress={e => this.props.navigation.navigate("Map")}>
